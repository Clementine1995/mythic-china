...
describe("application and production boundaries", () => {
  ...
  it("keeps Astro static and limits external interaction services", () => {
    ...
    expect(visualFiles).toEqual([
      ...
      "briefs/brief-fighting-cricket-hero-primary-v1.yml",
      "briefs/brief-liaozhai-hero-primary-v1.yml",
      "briefs/brief-liaozhai-reading-guide-hero-primary-v1.yml",
      "briefs/brief-painted-skin-hero-primary-v1.yml",
      "briefs/brief-ten-kings-hero-primary-v1.yml",
      ...
      "manifests/asset-fighting-cricket-hero-primary-v1.yml",
      "manifests/asset-liaozhai-hero-primary-v1.yml",
      "manifests/asset-liaozhai-reading-guide-hero-primary-v1.yml",
      "manifests/asset-painted-skin-hero-primary-v1.yml",
      "manifests/asset-ten-kings-hero-primary-v1.yml",
      ...
      "production-records/production-fighting-cricket-hero-primary-v1.yml",
      "production-records/production-liaozhai-hero-primary-v1.yml",
      "production-records/production-liaozhai-reading-guide-hero-primary-v1.yml",
      "production-records/production-painted-skin-hero-primary-v1.yml",
      "production-records/production-ten-kings-hero-primary-v1.yml",
    ...
    expect(repositoryImageFiles).toEqual([
      ...
      "fighting-cricket-hero-primary-v1-hero-desktop-3200w.webp",
      "fighting-cricket-hero-primary-v1-hero-mobile-1600w.webp",
      "liaozhai-hero-primary-v1-hero-desktop-3200w.webp",
      "liaozhai-hero-primary-v1-hero-mobile-1600w.webp",
      "liaozhai-reading-guide-hero-primary-v1-hero-desktop-3200w.webp",
      "liaozhai-reading-guide-hero-primary-v1-hero-mobile-1600w.webp",
      "painted-skin-hero-primary-v1-hero-desktop-3200w.webp",
      "painted-skin-hero-primary-v1-hero-mobile-1600w.webp",
      "ten-kings-hero-primary-v1-hero-desktop-3200w.webp",
      "ten-kings-hero-primary-v1-hero-mobile-1600w.webp",
