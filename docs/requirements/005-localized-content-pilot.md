...
> 2026-09-15 状态同步：英语阅读版 Public Beta 已公开，最近发布回执为 73e482a；真实 RUM 与其他技术/读者验收仍待补齐，入口见 [README](../../README.md)。本地化三页试点仍未实施，不阻塞英语阅读版。2026-09-12 确认的表单与视觉扩展包后移决定保持；历史记录不覆盖当前发布，也不把后移项记为完成。
...
当前站点为已公开的英语单语 public 站点，并保留独立的本地 review 构建：页面使用英语内容与 `lang="en"`，内容 Schema、发布投影、路由、导航和 SEO 尚不识别 locale。本文件只记录后续本地化目标合同，不把目标写成当前实现，也不授权开发、服务操作、版本控制写入或发布。
