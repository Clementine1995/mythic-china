...
上述“不负责”描述本文最初的决策/研究授权；2026-09-04 后续取得独立授权的最小内容物化与 Ten Kings、Fighting Cricket、Liaozhai Reading Guide 三篇纵切片由第 9–11 节及 [`008-four-entry-claim-maps.md`](008-four-entry-claim-maps.md) 第 13 节记录，不把后来的权限倒写成原批次范围。
