...
process.stdout.write(
  `Public output verified: ${pages.length} HTML, 2 XML, robots.txt, ${images.length} Hero images, ${seenFonts.size} fonts; zero executable scripts. Local diagnostic only; no release receipt or deployment.\n`,
);
